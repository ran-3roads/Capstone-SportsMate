...
export default function Manage() {
  ...
  useEffect(() => {
    ...
    axios
      .get(`/party/${id}/schedule/${schedule_id}/applyList`)
      .then(function (response) {
        if (response.status == 200) {
          setPermissions(response.data);
          return axios.get(`/party/${id}/schedule/${schedule_id}`);
        }
      })
      .then(function (response) {
        ...
        <Row className="justify-content-center">
          <Col md="7" className="text-center">
            ...
            <h6 className="subtitle">
              {schedule.title}의 인원수{schedule.currentMember}/
              {schedule.maxMember}
            </h6>
          </Col>
                          ...
                          <CommonTableColumn>
                            <button
                              ...
                              onClick={(event) => {
                                ...
                                axios
                                  .post(
                                    `/match/apply/${event.target.id}/accept`
                                  )
                                  .then(function (response) {
                                    //받는거
                                    if (response.status == 200) {
                            ...
                            <button
                              ...
                              onClick={(event) => {
                                ...
                                axios
                                  .post(
                                    `/match/apply/${event.target.id}/reject`
                                  )
                                  .then(function (response) {
                                    //받는거
                                    if (response.status == 200) {
