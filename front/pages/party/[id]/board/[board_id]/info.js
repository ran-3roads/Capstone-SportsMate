...
export default function Board_id() {
  ...
  useEffect(() => {
    ...
    axios
      .get(`/party/${id}/partyboard/${board_id}/comment`)
      .then(function (response) {
  ...
  return (
    <div>
      ...
      <PostView board_id={board_id}></PostView>
      <div id="view_comment" className="post-view-wrapper">
        <div className="cmt_box">
          <div id="comment_count">전체 댓글 {comments.length} 개 [등록순]</div>
                  ...
                  <CommonTableColumn>
                    <button
                      ...
                      onClick={(event) => {
                        ...
                        axios
                          .delete(
                            `/party/${id}/partyboard/${board_id}/comment/${event.target.id}`
                          )
                          .then(function (response) {
                            if (response.status == 200) {
                              alert("댓글이 삭제되었습니다.");
          ...
          <Form
            ...
            onSubmit={function (event) {
              event.preventDefault();
              if (event.target.text.value == "") alert("댓글을 입력해주세요");
              else {
                axios
                  .post(`/party/${id}/partyboard/${board_id}/comment`, {
