          ...
          <Col md="12">
            <Form className="col" id="ModifyForm" onSubmit={function (event) {
              ...
              <FormGroup className="col-md-6">
                ...
                <Input type="text" className="form-control" id="title" defaultValue={title ? title : partyinfo.title} onChange={onchangeTitle} />
              </FormGroup>
              <FormGroup className="col-md-6">
              ...
              <FormGroup className="col-md-6">
                ...
                <Input type="text" className="form-control" id="intro" defaultValue={intro ? intro : partyinfo.intro} onChange={onchangeIntro} />
              </FormGroup>
              <FormGroup className="col-md-6">
                <Label htmlFor="info">파티 정보글</Label>
                <Input type="text" className="form-control" id="info"  defaultValue={info ? info : partyinfo.info} onChange={onchangeInfo} />
              </FormGroup>
              <FormGroup className="col-md-6">
